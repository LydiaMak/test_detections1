...
t = pyfits.open('/local/lydia/Data/all_SWASP_data/output1/sci-results/src/src.fits')
...
pyfits.writeto("./input/bias.fits",bias,bias_header,clobber=True )
pyfits.writeto("./input/dark.fits",dark,dark_header,clobber=True )
pyfits.writeto("./input/flat.fits",flat,flat_header,clobber=True )
